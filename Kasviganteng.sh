...
echo $cyan" ["$red"+"$cyan"]Author by	: Mr Kasvi "
echo $cyan" ["$red"+"$cyan"]Team        : Indonesiacyberteam		"
echo $cyan" ["$red"+"$cyan"]IG          : Khairul_kasvi_spcs"
echo $cyan" ["$red"+"$cyan"]Github	: https://github.com/Mr kasvi"
